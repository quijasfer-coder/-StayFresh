          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="text-left font-mono text-[10px] uppercase tracking-widest text-bone-mute border-b border-bone-border/30">
                <th className="px-5 py-3 whitespace-nowrap">Nombre</th>
                <th className="px-5 py-3 whitespace-nowrap">Teléfono</th>
                <th className="px-5 py-3 whitespace-nowrap">Colonia</th>
                <th className="px-5 py-3 whitespace-nowrap">Recolecciones</th>
                <th className="px-5 py-3 whitespace-nowrap">Piezas totales</th>
              </tr>
            </thead>
            <tbody>
              {clients.map((client) => (
                ...
                >
                  ...
                  <td className="px-5 py-4 text-bone-mute whitespace-nowrap">{formatPhone(client.phone)}</td>
                  <td className="px-5 py-4 text-bone-mute whitespace-nowrap">{client.colonia ?? "—"}</td>
                  <td className="px-5 py-4 text-bone-mute whitespace-nowrap">{client.total_pickups}</td>
                  <td className="px-5 py-4 text-bone-mute whitespace-nowrap">{client.total_items}</td>
                </tr>
              ))}
              {clients.length === 0 && (
                <tr>
